...
async function fetchCotizave() {
  // Se lee la API Key DENTRO de la función para asegurar que tome la variable de Vercel
...
export default async function handler(req, res) {
  ...
  let bcv_usd = null, bcv_eur = null, source = 'error', error_details = null;
  ...
  if (czRes.status === 'fulfilled') {
    ...
    error_details = czRes.reason?.message;
    console.error('Cotizave failed:', error_details);
  }
